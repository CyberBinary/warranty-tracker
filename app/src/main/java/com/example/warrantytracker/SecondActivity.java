...
public class SecondActivity extends AppCompatActivity {
    ...
    List<dvice> deviceList = new ArrayList<dvice>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // specify an adapter
        mAdapter = new RecyclerViewAdapter(deviceList) {
        };
